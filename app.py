                ...
                if response.status_code == 200:
                    ...
                    for article in articles:
                        try:
                            ...
                            print(f"Error parsing news item: {parse_error}")
                            continue
...
def get_holdings():
    ...
    for holding in holdings:
        ...
        if stock_data:
            ...
            # P/L in percent
            holding_dict['pl_percent'] = ((holding_dict['value'] - entry_value) /
                                          entry_value) * 100 if entry_value > 0 else 0

            # Price change percent
            pct_change = ((stock_data['current_price'] - holding_dict['entry_price']) /
                          holding_dict['entry_price']) * 100
